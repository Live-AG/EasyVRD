...
Асинх Процедура СохранитьФайл(Команда)
	...
	ДиалогВыбораФайла.Фильтр = "(*.vrd)|*.vrd";
	ДиалогВыбораФайла.ПолноеИмяФайла = "default.vrd";
	...
	Если ЗначениеЗаполнено(РезультатВыбора) Тогда
		ТекстНастройки.Записать(РезультатВыбора[0]);
	КонецЕсли;
...
&НаСервере
Процедура ЗаполнитьПоМетаданным()
...
КонецПроцедуры // УстановитьПометкуВсехHTTPСервисов(Пометка)
